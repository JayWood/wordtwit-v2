...
function wtSetupTweetLog() {
	...
	jQuery( '#bnc-submit' ).on( 'click', function() {
...
function wtSetupTabSwitching() {
	...
	if ( adminTabSwitchLinks.length ) {
		adminTabSwitchLinks.on( 'click', function( e ) {
			var targetTabId = '';
...
function wtSetupGlobals() {
	...
	jQuery( '#contributors_can_add_accounts' ).on( 'change', function() {
	...
	jQuery( '#url_shortener' ).on( 'change', function() {
	...
	jQuery( 'a#estimate-offset' ).on( 'click', function( e ) {
	...
	jQuery( '#setting_custom_consumer_key, #custom_consumer_key' ).on( 'change', function() {
