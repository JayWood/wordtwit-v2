<input type="password" autocomplete="off" class="text" id="<?php wordtwit_the_tab_setting_name(); ?>" name="<?php wordtwit_the_tab_setting_name(); ?>" value="<?php wordtwit_the_tab_setting_value(); ?>" />
