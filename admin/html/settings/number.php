<input type="text" autocomplete="off" class="text number" id="<?php wordtwit_the_tab_setting_name(); ?>" name="<?php wordtwit_the_tab_setting_name(); ?>" value="<?php wordtwit_the_tab_setting_value(); ?>" />
